...
impl Permissions {
    ...
    pub const OPERATOR_ALL: Self = Self(Self::UPDATE_PRICE.0 | Self::VIEW_METRICS.0);
...
impl GovernanceState {
    ...
    pub fn grant_member_permission(
        &mut self,
        member_index: usize,
    ...
    pub fn revoke_member_permission(
        &mut self,
        member_index: usize,
        permission: Permissions,
    ) -> Result<()> {
    ...
    pub fn check_member_permission(
        &self,
        member_key: &Pubkey,
